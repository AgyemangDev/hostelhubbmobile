...
export const bookHostelCheck = async ({
  userInfo,
  user,
  db,
  onButtonPress,
  ...
  if (!userInfo.paymentStatus) {
    if (userInfo.balance < ACCESS_FEE) {
      ...
      Alert.alert(
        "Confirm Deduction",
        `HostelHubb would like to deduct ${ACCESS_FEE} from your account to access full functionality as a subscription fee for 3 months.`,
        [
