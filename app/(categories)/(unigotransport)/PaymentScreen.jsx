...
<View style={styles.noticeCard}>
  ...
  <Text style={styles.noticeText}>
    Payment is handled securely by Mobile Money or card. Your seat is only
    confirmed once payment succeeds — nothing is held until then.
  </Text>
</View>
